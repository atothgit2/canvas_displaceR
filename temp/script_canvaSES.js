...
class Canvas {
  constructor() {
    ...
    document.getElementById('canvas2').style.border = "2px solid black";
    document.getElementById('canvas2').style.position = "absolute";
